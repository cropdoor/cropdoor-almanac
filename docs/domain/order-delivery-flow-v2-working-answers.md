...
| 22 | "Partial refund", "replacement", "goodwill credit" — what actually happens, who moves what money, who pays for a replacement delivery? | POLICY | S2 | None of these outcomes moves money today. Each needs a rail: partial refund = a refund of a stated amount; replacement = a new order at whose cost?; goodwill credit = a buyer balance we do not have. Pick which outcomes we actually offer. | **Decided 10 Sep (CTO): two outcomes only** — partial refund of a stated amount, or full refund. No replacement, no goodwill credit for now. | A dispute resolves to an amount (part or whole). Online: a refund from escrow, the farmer's payable reduced by the same. Cash: see 23 |
...
| --- | --- |
| Buyer refuses at the door / absent | 12, 14 (mechanics: DELIVERY FAILED; policy open) |
